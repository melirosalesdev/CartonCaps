...
**Considerations 
	...
	Run this Api: open the command console on folder CartonCaps.Api, and execute "dotnet run".

	Run tests: open the command console on folder CartonCaps.Test, and execute "dotnet test".
